...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import snappy_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("fe1e1685-f7be-5f59-ac9f-4ca204017dfd"))
platforms = [Pkg.Artifacts.unpack_platform(e, "snappy", artifacts_toml) for e in artifacts["snappy"]]
...
if best_platform === nothing
    @debug("Unable to load snappy; unsupported platform $(triplet(platform_key_abi()))")
else
