# Autogenerated wrapper script for snappy_jll for x86_64-apple-darwin14-cxx11
export libsnappy
...
const libsnappy_splitpath = ["lib", "libsnappy.1.1.8.dylib"]
...
const libsnappy = "@rpath/libsnappy.1.dylib"
